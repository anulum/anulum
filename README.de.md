...
Ich entwickle **evidenzbasierte Infrastruktur** für KI-Systeme,
Multi-Agenten-Engineering, wissenschaftliches Rechnen, neuromorphe Hardware,
Quantensimulation und Regelung. Die Arbeit verbindet mathematische Modelle mit
reproduzierbarer Software, nativer Beschleunigung, formalen Modellen und
ausführbaren Hardwarepfaden.
...
**Primäre Implementierung:** Python, Rust, TypeScript, JavaScript und Go.

**Wissenschaftlich und nativ:** Julia, Mojo, C++, C, Lean 4, Jupyter und LaTeX.

**Hardware, Web und Betrieb:** Verilog, SystemVerilog, WGSL/WebGPU, HTML/CSS,
Shell, Docker und Linux.
...
Gruppen: 33 öffentliche Repositories und sechs private Produktbereiche.
...
**Statusschlüssel:** `ÖFFENTLICH` · `ÖFFENTLICH / NUR ARCHITEKTUR` · `PRIVAT` · `PRIVAT / PROPRIETÄR`
...
- [SCPN Lattice Fusion Core](https://github.com/anulum/scpn-lattice-fusion-core): `ÖFFENTLICH / NUR ARCHITEKTUR`
- [SCPN Muon Fusion Core](https://github.com/anulum/scpn-muon-fusion-core): `ÖFFENTLICH / NUR ARCHITEKTUR`
...
- [HushLine](https://github.com/anulum/HushLine): Deterministischer
  Kommando-Wrapper zum Filtern, Begrenzen und optionalen Redigieren von stdout
  und stderr.
...
<p>
  ...
  <img alt="mypy" src="https://img.shields.io/badge/Typen-mypy-2A6DB2?style=flat-square">
  <img alt="Cargo" src="https://img.shields.io/badge/Nativ-Cargo-000000?style=flat-square&logo=rust&logoColor=white">
  <img alt="CodeQL" src="https://img.shields.io/badge/Sicherheit-CodeQL-2f81f7?style=flat-square&logo=github&logoColor=white">
  <img alt="REUSE" src="https://img.shields.io/badge/Lizenzen-REUSE_3.x-4dd6c8?style=flat-square">
</p>
...
|---|---|
| Korrektheit | Deterministische pytest- und Cargo-Suiten, Coverage-Gates, Paritätstests, Regressions-Fixtures und explizite Negativfälle |
| Statische Qualität | Ruff, striktes mypy wo deklariert, Cargo fmt, Clippy mit verbotenen Warnungen und API-Vertragsprüfungen |
| Reproduzierbarkeit | Hash-fixierte Abhängigkeiten, präregistrierte Protokolle, Rohdatenpakete, Inhaltsdigests und wiederholbare Auditaufzeichnungen |
| Sicherheit | Bandit, CodeQL und Scorecards wo aktiviert, Bedrohungsmodelle, minimale Autorität und Abhängigkeitsprüfung |
| Lieferkette | SPDX, REUSE 3.x, SBOMs wo anwendbar, fixierte CI-Actions und Release-Manifeste |
| Polyglotte Prüfung | Python/Rust-Parität, PyO3/Maturin, Go- und Julia-Tests, Lean-Builds, WebAssembly sowie RTL- und Formalprüfungen |
| Dokumentation | Strikte MkDocs/Sphinx-Builds, API-Referenzen, Architekturentscheidungen, Validierungsakten und explizite Nicht-Claims |

## PyPI-Veröffentlichungen

<p align="center">
  <a href="https://pypi.org/user/anulum/"><img alt="Miroslav Sotek auf PyPI" src="https://img.shields.io/badge/PyPI-Miroslav_Sotek_%40_anulum-3775a9?style=for-the-badge&logo=pypi&logoColor=white"></a>
</p>
